...
export default function APBMTHomepage() {
  ...
  const abstractCategories = [
    ...
    // },
    {
      ...
      icon: Activity,
      description: 'Competitive paper presentations with awards for best entries'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* NCPID Banner Image */}
      <div className="w-full">  {/* mb-6 हटाएं */}
        <img
      ...
      <section className="bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-blue-200 mb-8 max-w-2xl mx-auto">
            <p>HOSTED BY - PEDIATRIC INFECTIOUS DISEASES ACADEMY [PIDA]</p>
            <p>CO-HOSTS-IAP-ID KARNATAKA CHAPTER, IAP BENGALURU</p>
          </p>
